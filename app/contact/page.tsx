              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <a href="tel:+201044114633" className="text-gray-900 hover:text-blue-600 transition-colors">
                      +20 104 411 4633
                    </a>
                  </div>
                  <div className="flex items-center space-x-3">
            ...
            <CardContent>
              <form action={formAction} className="space-y-6">
                ...
                <p className="text-xs text-gray-500 text-center">
                  Your message will be sent to: info@targetco-egypt.com
                </p>
              </form>
            </CardContent>
          </Card>
