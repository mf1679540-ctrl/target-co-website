          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <Card className="p-8">
              ...
              <CardContent className="space-y-6">
                <div className="mb-6">
                  <Image
                    src="/pharmaceutical-installation.png"
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-500" />
                    <span className="text-gray-700">Performance validation and commissioning</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-500" />
                    <span className="text-gray-700">Documentation and certification</span>
                  </div>
                </div>
            ...
            <Card className="p-8">
              ...
              <CardContent className="space-y-6">
                <div className="mb-6">
                  <Image
                    src="/pharmaceutical-maintenance.png"
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-500" />
                    <span className="text-gray-700">Remote diagnostics and troubleshooting</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-500" />
            ...
            <Card className="p-8">
              ...
              <CardContent className="space-y-6">
                <div className="mb-6">
                  <Image
                    src="/pharmaceutical-training.png"
            ...
            <Card className="p-8">
              ...
              <CardContent className="space-y-6">
                <div className="mb-6">
                  <Image
                    src="/pharmaceutical-consultation.png"
